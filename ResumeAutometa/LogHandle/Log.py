...
from ResumeAutometa.Config.file_paths import LOG_CLUSTER_LOCATION, LOG_CONFIG_LOCATION
...
class Log:
    def __init__(self, name, cluster_name):
        log_filename = LOG_CLUSTER_LOCATION + cluster_name + "/" + name + ".txt"
        cf = configparser.RawConfigParser()
        cf.read(LOG_CONFIG_LOCATION)

        # 通用配置
        config_name = cluster_name + "_" + name
...
if __name__ == '__main__':
    log_handler = Log("crawler_manager", "crawler")
