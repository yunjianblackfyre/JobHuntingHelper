...
class IdfComputer(object):
    ...
    def __init__(self, train_file, idf_file, wordid_file, idword_file):
        ...
        # 后续根据任务的进行会发生改变的变量
        self.train_file = IDF_FILTER_EXTRACT_RESOURCES + train_file
        self.idf_file = IDF_FILTER_EXTRACT_RESOURCES + idf_file
        self.wordid_file = IDF_FILTER_EXTRACT_RESOURCES + wordid_file
        self.idword_file = IDF_FILTER_EXTRACT_RESOURCES + idword_file
        self.Doc_count = 0
        self.word_count = 0
        self.id2word = {}
        self.word2idf = {}
...
if __name__ == '__main__':
    tool_training = IdfComputer("idf_filter_data_training.txt", "idf_filter_wordidf.txt",
                                "idf_filter_wordid.txt", "idf_filter_idword.txt")
    tool_training.main()
